...
public class AddPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostDatabase = FirebaseDatabase.getInstance().getReference().child("MPhoto");
    ...
    private void startPosting() {
        ...
        if (!TextUtils.isEmpty(titleVal) && !TextUtils.isEmpty(descVal)
            ...
            StorageReference filepath = mStorage.child("MPhoto_images").child(mImageUri.getLastPathSegment());
            filepath.putFile(   mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    startActivity(new Intent(AddPhotoActivity.this, PostListActivity.class));
                    finish();
